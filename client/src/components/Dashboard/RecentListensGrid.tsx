...
const ListenItem: React.FC<ListenItem> = ({ title, artist, imageUrl }) => (
  <NavLink
  to={`Songpage`} // Set dynamic route (e.g., song details page)
  className="flex flex-col grow items-start pt-44 pr-12 pb-4 pl-5 w-full text-white rounded-3xl bg-cover bg-center bg-no-repeat max-md:pt-24 max-md:pr-5 max-md:mt-2.5"
